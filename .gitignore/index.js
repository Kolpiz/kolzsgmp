...
const channel = member.guild.channels.find("name", "👋bienvenue").send(`Bienvenue ${member.user} sur **🔴🔷Parks-Mc Community 2.0🔷🔴**🎉🤗 !`)
...
const channel = member.guild.channels.find('name', "👋bienvenue").send(` **${member.user.username}** a quitté notre communautés! 😯`);
});
